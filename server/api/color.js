 ...
 * @param  {String} kelvin - a Kelvin color temp
 * @return {Object} rgb - an object with RGB values
 */
 ...
 * @return {Object} rgb - an object with RGB values
 */
export function kelvinToRGBTH(kelvin) {
  const temperature = kelvin / 100.0;
 ...
 * @param  {String} rgb - an RGB value
 * @return {String} kelvin - a Kelvin color temp
 */
